define([ 
	...
	MethodDirCtrl.controller = function( $scope, $element, $timeout ) {
		...
		var firepad = Firepad.fromCodeMirror($scope.firebase.ref.child("users/"+$scope.app.owner+"/apps/"+$scope.app.id+"/things/"+method.thing.name+"/methods/"+method.name+"/pad"), editor);
